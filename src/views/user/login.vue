<template>
  <div v-if="true" class="login-div" >
    ...
    <h3 class="login_title">{{this.thePageTile}}</h3>
    ...
    <el-checkbox class="login_remember" v-model="checked"
      ...
      <el-button style="float: right; background: rgba(255,255,255,0)"  size="mini" @click="$router.push({path:'/register'})">注册</el-button>
  ...
  export default{
    ...
    methods: {
      submitClick: function () {
        ...
        this.postLoginRequest('/api' + this.loginUrl, {
...
<style>
  .login-div{
    width: 100%;
    height: 100%;
    background: url('../../assets/img/loginImg/loginbgi.png');
